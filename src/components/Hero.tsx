      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Now in Version 1.0.4</span>
          </motion.div>
          ...
          >
            The first cross-platform ecosystem that uses Edge AI to recognize your focus patterns and keep you in the zone.
          </motion.p>
